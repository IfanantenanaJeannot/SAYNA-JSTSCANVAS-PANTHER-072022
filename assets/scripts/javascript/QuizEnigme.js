...
const enigme1 = document.querySelector(".quest");
const enigme2 = document.querySelector(".quest-2");
const enigme3 = document.querySelector(".quest-3");
const closeP = document.getElementById('close');
const indice = document.querySelector(".indice div");
